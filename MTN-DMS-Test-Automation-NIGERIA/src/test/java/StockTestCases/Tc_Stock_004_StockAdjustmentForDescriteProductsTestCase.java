...
public class Tc_Stock_004_StockAdjustmentForDescriteProductsTestCase extends BaseClassLoader {
	HashMap<String, String> input = new HashMap<String, String>();

	@Test
	public void StockAdjustmentForDescriteProducts() throws Exception {
		...
		for (int n = 1; n < 2; n++) {
			...
			if (stockdata.Excelread("StockadjBurntCheck",n,8).equalsIgnoreCase("yes")) {
				...
				input.put("descProductCode", stockdata.Excelread("StockadjBurntCheck",n,0) );
				input.put("descBatchNo",stockdata.Excelread("StockadjBurntCheck",n,2));
				input.put("descMRP",stockdata.Excelread("StockadjBurntCheck",n,3));
				input.put("descProductName",stockdata.Excelread("StockadjBurntCheck",n,1));
				input.put("descProductFromSerialNo",stockdata.Excelread("StockadjBurntCheck",n,5));
				input.put("descProductToSerialNo",stockdata.Excelread("StockadjBurntCheck",n,6));
				input.put("descProductQty",stockdata.Excelread("StockadjBurntCheck",n,7));
			...
			}else if (stockdata.Excelread("StockadjBurntCheck",n,8).equalsIgnoreCase("no"))  {
				
				input.put("nondescProductCode",stockdata.Excelread("StockadjBurntCheck",n,0));
				input.put("nondescBatchNo", stockdata.Excelread("StockadjBurntCheck",n,2));
				input.put("nondescMRP", stockdata.Excelread("StockadjBurntCheck",n,3));
				input.put("nondescProductName", stockdata.Excelread("StockadjBurntCheck",n,1));
				input.put("nondescProductQty",stockdata.Excelread("StockadjBurntCheck",n,7));
		...
		if (stockdata.Excelread("StockadjBurntCheck",n,8).equalsIgnoreCase("yes")) {
			if (sadj.getNumOfRows() >= 1) {
				...
				sadj.ClickonSerialNoLinkAtRow(n);
				...
				input.put("ProductReleaseQty", sadj.getQty(n));
				...
				ast.assertEquals(input.get("descProductCode"), sadj.getRowWiseProductCode(n), "Popup Product code and Main Product Code is not matching");
				ast.assertEquals(input.get("descProductName"), sadj.getRowWiseProductName(n), "Popup Product Name and Main Product Name is not matching");
				ast.assertEquals(input.get("descBatchNo"), sadj.getRowWiseBatchNo(n), "Popup Product Batch Number  and Main Product Batch Number is not matching");
				ast.assertEquals(input.get("descMRP")+"0", sadj.getRowWiseMRP(n), "Popup Product MRP and Main Product MRP is not matching");
			...
			if (sadj.getNumOfRows() >= 1) {
				...
				ast.assertEquals(input.get("nondescProductCode"), sadj.getRowWiseProductCode(n), "Popup Product code and Main Product Code is not matching");
				ast.assertEquals(input.get("nondescProductName"), sadj.getRowWiseProductName(n), "Popup Product Name and Main Product Name is not matching");
				ast.assertEquals(input.get("nondescBatchNo"), sadj.getRowWiseBatchNo(n), "Popup Product Batch Number  and Main Product Batch Number is not matching");
				ast.assertEquals(input.get("nondescMRP")+".00", sadj.getRowWiseMRP(n), "Popup Product MRP and Main Product MRP is not matching");
					...
					if (stb.getNumOfMainProductRows() >= 1) {
						...
						for (int i = 1; i <= stb.getNumOfMainProductRows();) {
							...
							if (getdescprodcode.contains(input.get("descProductCode"))
								...
								ast.assertEquals(stb.getHoldStockAtRow(i), input.get("descHoldStock"),"Descrite Product Hold Stock verification failed");
								...
								ast.assertEquals(stb.getBurntStockAtRow(i), String.valueOf(Long.parseLong(input.get("descBurntStock"))+1),"Descrite Product Burnt Stock verification failed");
					...
					if (stb.getNumOfMainProductRows() >= 1) {
						...
						for (int i = 1; i <= stb.getNumOfMainProductRows();) {
							...
							if (getnondescprodcode.contains(input.get("nondescProductCode"))
								...
								ast.assertEquals(stb.getHoldStockAtRow(i), input.get("nondescHoldStock"),"Descrite Product Hold Stock verification failed");
								...
								ast.assertEquals(stb.getBurntStockAtRow(i), String.valueOf(Long.parseLong(input.get("nondescBurntStock"))+1),"Descrite Product Burnt Stock verification failed");
