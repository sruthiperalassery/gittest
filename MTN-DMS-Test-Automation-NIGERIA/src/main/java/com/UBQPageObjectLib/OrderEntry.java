...
public class OrderEntry extends WebDriverCommonLib {
	...
	// For Click Shippingaddresslink
		...
		public int getNumOfProductRows() {
			List<WebElement> size = driver.findElements(By.xpath("//table[@id='billDetailsTable']/tbody[2]/tr"));
			return size.size();
		}
		
		public void selectProductName(int row){
			WebElement element = driver.findElement(
				By.xpath("//table[@id='billDetailsTable']/tbody[2]/tr["+row+"]/td[2]/input"));
		...
		//---For enter product code---//
		public void enterOrderQty(String Qty) {
			OrderQty.clear();
			acceptAlert();
			entervalue(Qty,OrderQty);
			OrderQty.sendKeys(Keys.TAB);
